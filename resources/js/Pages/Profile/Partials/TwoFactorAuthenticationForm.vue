...
<template>
    <ActionSection>
        ...
        <template #content>
            <div class="px-3 pb-4">
                <h3 v-if="twoFactorEnabled && ! confirming" class="text-lg font-medium text-electricgreen">
                    You have enabled two factor authentication.
                </h3>

                <h3 v-else-if="twoFactorEnabled && confirming" class="text-lg font-medium text-electricgreen">
                    Finish enabling two factor authentication.
                </h3>

                <h3 v-else class="text-lg font-medium text-darkorchid">
